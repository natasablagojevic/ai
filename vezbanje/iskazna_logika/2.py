...
class Formula:
    ...
    """
        ZADOVOLJIVA
        -   postoji valuacija u kojoj je formula tacna
    """
    def is_satisfiable(self):
        varaibles = list(self.get_all_components())
        for valuation in get_all_valuations(varaibles):
    ...
    """
        VALIDNA/TAUTOLOGIJA
        -   u svakoj valuaciji formule je tacna
    """
    def is_valid(self):
    ...
    """
        KONTRADIKCIJA/NEVALIDNA
        -   u svakoj valuaciji formule je netacna
    """
    ...
    """
        PORECIVA
        -   postoji valuacija u kojoj je formula netacna
    """
